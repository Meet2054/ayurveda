...
export function CardDemo() {
  return (
    <div className="relative overflow-hidden w-full h-100 flex items-center">
      <div
        className={cn(
          "flex space-x-12 py-4 animate-slide p-4"
        )}
      ...
      >
        {cardsData.map((card, index) => (
          <div
            key={index}
            className="min-w-xs max-w-xs w-full group/card transform transition-transform"
          >
            <div
              className={cn(
