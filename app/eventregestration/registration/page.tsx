...
interface RegistrationProps {
  eventId: number; // Props to pass the specific event ID
}
...
const Registration: React.FC<RegistrationProps> = ({ eventId }) => {
    ...
    return (
        <div className="bg-gray-900 text-white min-h-screen flex justify-center items-center">
            <div className="max-w-md w-full bg-gray-800 rounded-lg shadow-2xl p-8">
                <h1 className="text-4xl font-bold text-center mb-6">Event Registration</h1>
                <form onSubmit={handleSubmit} className="space-y-4">
                    {/* Name Field */}
                    <div className="py-3">
                        <input
                    ...
                    <div className="py-3">
                        <label className="inline-flex items-center">
                            <input
                                ...
                                className="form-checkbox h-5 w-5 text-green-500"
                            />
                            <span className="ml-2 text-gray-300">I accept the Terms and Conditions</span>
                        </label>
                    </div>
